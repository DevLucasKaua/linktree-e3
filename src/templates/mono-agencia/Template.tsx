...
/** Template Mono: card de perfil com redes no topo e botões flat com seta. */
export function Template({ config, photoSrc, vcardSrc }: TemplateProps) {
  ...
  return (
    <main className="pagina">
      {/* Card de perfil com redes dentro (padrão mono agência) */}
      <header className="card-perfil">
        <div className="foto">
          {photoSrc ? (
        ...
        return (
          ...
          >
            ...
            <span className="botao-texto">
              ...
              {item.description && (
                <span className="botao-desc">{item.description}</span>
              )}
            </span>
            <i className="ti ti-arrow-right seta" />
            {item.highlight && (
              <span className="selo">
